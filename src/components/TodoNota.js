...
<div className="col-6" style={{padding: "0px", borderLeft:"solid",  borderWidth: "2px",}}>
      {/***Prodotti********************** */}
    {sup ===true && todo.flagTinte===false && localStorage.getItem("completa") == 0 &&( 
      <Autocomplete
      value={newProdotto}
      options={AutoProdCli}
    ...
    {sup ===true && todo.flagTinte===false && localStorage.getItem("completa") == 1 &&( 
      <h3 className="inpTabNota" style={{ marginLeft: "12px"}}> {todo.prodottoC} </h3>
    )}

      {/*****Tinte********************************************************************/}
    {sup ===true && todo.flagTinte===true && localStorage.getItem("completa") == 0 &&( 
      <>
    ...
    {sup ===true && todo.flagTinte===true && localStorage.getItem("completa") == 1 &&(
      <>
...
{/***************************************************************************************************** */}
      ...
      <button hidden
        ...
        {sup ===true && flagStampa==false && localStorage.getItem("completa") == 0 && (   
