...
function StampaMassivaPrev({notaId, cont, nomeCli, dataNotaC, numCart, numBust, prezzoTotNota, debit, debTo, completa, idDebito }) {
...
//************************************************************** */
    return (  
      ...
      <p className='navText'> Stampa Massiva Prev</p>
      </div>
      </div>
...
{!matches && 
  <button className="backArrowPage" style={{float: "left"}}
      ...
      {!matches ? <h1 className='title mt-3'> Stampa Massiva  Prevenzione</h1> : <div style={{marginBottom:"60px"}}></div>} 
...
export default StampaMassivaPrev;